...
const containerVariants = {
  ...
  visible: {
    transition: {
      staggerChildren: 0.3, // aparecen de a una suavemente
    },
  },
};
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div className="inline-block relative mb-8 sm:mb-12" variants={elementVariants}>
            <div className="bg-gradient-to-br from-pink-200 to-rose-300 w-20 h-20 sm:w-32 sm:h-32 rounded-full flex items-center justify-center mx-auto shadow-xl">
